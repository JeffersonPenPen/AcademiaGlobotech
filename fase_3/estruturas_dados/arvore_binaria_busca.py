class No:
    ...
    def __init__(self, chave, valor):
        ...
        self.valor = valor        # conteúdo associado à chave (ex: objeto Usuario, Conteudo, etc.)
...
class ArvoreBinariaBusca:
    ...
    def inserir(self, chave, valor):
        #Insere Substitui chave, valor na árvore.
    ...
    def _remover_recursivo(self, no, chave):
        ...
        if chave < no.chave:
            ...
            if no.direita is None:
                return no.esquerda
            #Dois filhos, com substituiçao do menor da subárvore direita
